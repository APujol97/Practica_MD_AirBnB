...
```{r, include=FALSE}
mapa <- rgdal::readOGR(
          paste0("./data/lineas_limite/recintos_municipales_inspire_peninbal_etrs89/",
...
mapa_arg <- rgdal::readOGR(
          paste0("./data/lineas_limite/municipios_arg/",
...
mapa_mex <- rgdal::readOGR(
          paste0("./data/lineas_limite/municipios_mex/",
...
mapa_bcn <- rgdal::readOGR(
          paste0("./data/lineas_limite/barcelona_distrito/",
...
mapa_vlc <- rgdal::readOGR(
          paste0("./data/lineas_limite/valencia_distrito/",
