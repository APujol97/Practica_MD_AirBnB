...
library(readr)
library(naniar)
library(tidyverse) #no sabemos si es necesaria
...
```
```{r}
reviewsMallorca <- read_csv("data/Mallorca/reviews.csv.gz")
reviewsBarcelona <- read_csv("data/Barcelona/reviews.csv.gz")
reviewsValencia<- read_csv("data/Valencia/reviews.csv.gz")
reviewsMexico<- read_csv("data/Mexico/reviews.csv.gz")
reviewsBuenosAires<- read_csv("data/Buenos_Aires/reviews.csv.gz")
